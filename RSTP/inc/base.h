...
extern unsigned short Ntohs (unsigned short n); 
extern unsigned long  Htonl (unsigned long  h);   
extern unsigned short Htons (unsigned short h);
extern unsigned long  Ntohl (unsigned long  n);
...
#else
extern unsigned long stp_trace (const char* fmt, ...);
#endif
