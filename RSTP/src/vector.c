...
STP_VECT_get_vector (IN BPDU_BODY_T* b, OUT PRIO_VECTOR_T* v)
{
  ...
  v->root_path_cost = ntrhl (*((long*) b->root_path_cost));
//  v->root_path_cost =  (*((long*) b->root_path_cost));
...
STP_VECT_set_vector (IN PRIO_VECTOR_T* v, OUT BPDU_BODY_T* b)
{
  ...
  root_path_cost = ntrhl (v->root_path_cost);
//  root_path_cost =  (v->root_path_cost);
